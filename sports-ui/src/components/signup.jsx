...
import { fetchCreateUserRequest, updateMessage, fetchUserRequest} from "../../store/actions/sportsActions";
...
export default function SignUp() {
  ...
  const handleLogin = (e) => {
    e.preventDefault();
    dispatch(fetchCreateUserRequest(formData.user));
  };
